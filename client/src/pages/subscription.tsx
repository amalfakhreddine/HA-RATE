...
export default function SubscriptionPage() {
  ...
  return <div className="min-h-screen bg-[#09040f] pb-24 text-white">
    <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      <Card className="overflow-hidden border-fuchsia-500/30 bg-gradient-to-br from-purple-950/80 via-[#11121a] to-[#08090e]">
        <div className="grid md:grid-cols-[1fr_320px]">
          <div className="p-7 md:p-9">
            ...
            <ul className="space-y-3 text-slate-300 mb-7"><li className="flex gap-2"><Pickaxe className="w-5 h-5 text-purple-300"/>2,500 HA-RATE per 6-hour claim instead of 500</li><li className="flex gap-2"><ShieldCheck className="w-5 h-5 text-purple-300"/>active for 30 days</li><li className="flex gap-2"><Zap className="w-5 h-5 text-purple-300"/>no auto-renewal</li></ul>
          ...
          <div className="min-h-[330px] relative bg-[#08030d]"><img src="/dragon-level-15.jpg" className="absolute inset-0 w-full h-full object-cover" alt="Boosted HA-RATE dragon"/><div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-purple-950/20"/></div>
        </div>
      </Card>
    </main>
  </div>;
