...
export default function MiningPage() {
  ...
  return (
    <div className="min-h-screen bg-[#06070b] pb-24 text-white">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-7 space-y-6">
        <section className="grid lg:grid-cols-[1.15fr_.85fr] gap-6 items-stretch">
          ...
          <Card className="border-purple-500/20 bg-[#0b0c12] p-6 flex items-center justify-between">
            <div><p className="text-xs uppercase tracking-[0.2em] text-slate-500 mb-2">Current mining rate</p><div className="text-3xl font-black">{500 * miningPower} <span className="text-lg text-purple-300">MIZ / claim</span></div><p className="text-sm text-slate-500 mt-2">one claim every 6 hours</p></div>
